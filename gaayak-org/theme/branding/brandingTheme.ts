...
export const getDesignTokens = (mode: 'light' | 'dark') =>
  ({
    palette: {
      ...
      divider: mode === 'dark' ? alpha(grey[500], 0.3) : grey[200],
      primaryDark: purpleDark,
      mode,
      ...(mode === 'dark' && {
        background: {
          default: purpleDark[900],
          paper: alpha(purpleDark[800], 0.8),
        },
      }),
      common: {
        black: 'hsl(200, 10%, 4%)',
      ...
      gradients: {
        radioSubtle:
          mode === 'dark'
            ? `radial-gradient(100% 100% at 100% 100%, transparent 0, ${alpha(purple[900], 0.3)} 300%)`
            : `radial-gradient(100% 90% at 50% 0, transparent 0, ${alpha(purple[100], 0.3)} 300%)`,
        linearSubtle:
          mode === 'dark'
            ? `linear-gradient(0deg, ${alpha(purple[900], 0.1)}, ${alpha(purpleDark[900], 0.5)})`
            : `linear-gradient(0deg, ${alpha(purple[50], 0.4)}, ${alpha(grey[50], 0.1)})`,
      },
    },
    shape: {
      borderRadius: 12,
    ...
    typography: {
      ...
      h1: {
        ...
        lineHeight: 78 / 70,
        letterSpacing: -0.2,
        // ...(mode === 'light' && { color: purpleDark[900] }),
      },
      h2: {
        fontFamily: ['"General Sans"', ...systemFont].join(','),
        ...
        lineHeight: 44 / 36,
        letterSpacing: -0.2,
        // color: mode === 'dark' ? grey[100] : purpleDark[700],
      },
      h3: {
        fontFamily: ['"General Sans"', ...systemFont].join(','),
      ...
      h5: {
        ...
        lineHeight: 36 / 24,
        letterSpacing: 0.1,
        // color: mode === 'dark' ? purple[300] : purple.main,
      },
      h6: {
          ...
          root: ({ theme, ownerState }) => [
            {
              backgroundImage: 'none',
              backgroundColor: '#fff',
              borderColor: 'transparent',  // NEW: default transparent border
              borderWidth: 1,             // NEW: consistent border width
              borderStyle: 'solid',       // NEW: consistent border style
              '&[href]': {
                textDecorationLine: 'none',
              },
              transition: theme.transitions.create(['border', 'box-shadow', 'background-color'], // NEW: added background-color
                {
            ...
            theme.applyDarkStyles({
              backgroundColor: (theme.vars || theme).palette.primaryDark[900],
              borderColor: alpha(theme.palette.grey[700], 0.2),  // NEW: subtle border for all Papers
              ...(ownerState.variant === 'outlined' && {
                borderColor: (theme.vars || theme).palette.primaryDark[700],
